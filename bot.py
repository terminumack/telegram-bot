...
async def backup(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if file_bytes: await update.message.reply_document(document=file_bytes, filename=file_bytes.name, caption="🔒 <b>Backup de Seguridad</b>", parse_mode=ParseMode.HTML)
    else: await update.message.reply_text("❌ Error al generar backup.")
